...
exports.editEvent = async (req, res) => {
    ...
    // TODO fix this so the status get changed upon saving
    // if (['first draft', 'first submission', 'first approval'].includes(oldStatus)) {
    //     this.setApprovalStatus('first submission')
    // }

    // if (['second draft', 'second submission', 'second approval'].includes(oldStatus)) {
    //     this.setApprovalStatus('second submission')
    // }
...
exports.setApprovalStatus = async (req, res) => {
    ...
    await sequelize.transaction(async (t) => {
        ...
        await req.event.update({ status: req.body.status, organizers: event.organizers }, { transaction: t });
