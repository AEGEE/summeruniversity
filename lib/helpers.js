...
exports.getEventPermissions = ({ permissions, event, user }) => {
    ...
    // TODO event.status check if draft is good enough
    permissions.edit_summeruniversity = (event.status === 'draft' && exports.isOrganizer(event, user)) || permissions.manage_summeruniversity[event.type];
    ...
    // TODO fix this with the status changes
    // Status transitions.
